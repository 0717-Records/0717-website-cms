...
// Query: *[_type == "blogPost"]|order(coalesce(overrideDate, _createdAt) desc){  _id,  _createdAt,  title,  subtitle,  author,  heroImage{    asset,    alt,    hotspot,    crop  },  hasOverrideDate,  overrideDate,  hasClosingCard,  closingCard}
