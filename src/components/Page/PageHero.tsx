    ...
    <section
      ...
      {showBackLink && (
        <div className='absolute top-4 left-4 md:top-8 md:left-8 z-[25]'>
          <Link
            href={backLinkHref}
            className='inline-flex items-center gap-2 text-white hover:bg-black active:scale-90 transition-all duration-200 text-sm md:text-base bg-black/30 backdrop-blur-sm rounded-lg px-3 py-2 border border-white/20'>
            <span>←</span>
