...
const DefaultHeroBackground = () => {
  ...
  return (
    <div
      ...
      <div className='absolute bottom-0 left-1/2 sm:left-0 w-[70vw] h-[70vw] sm:w-[35vw] sm:h-[35vw] rounded-full bg-gradient-to-tr from-[#ffea00]/20 to-[#ffea00]/10 transform -translate-x-1/2 translate-y-1/2 blur-sm' />
      ...
      <div className='absolute hidden md:block md:right-0 top-0 right-1/2 w-[50vw] h-[50vw] rounded-full bg-gradient-to-bl from-[#ffea00]/30 to-[#f4a300]/20 transform translate-x-1/2 -translate-y-1/2 blur-xl' />
      <div className='absolute hidden md:block md:right-0 top-0 right-1/2 w-[40vw] h-[40vw] rounded-full bg-gradient-to-bl from-[#ffea00]/30 to-[#f4a300]/20 transform translate-x-1/2 -translate-y-1/2 blur-sm' />
    </div>
  );
};
