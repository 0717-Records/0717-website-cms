...
const DefaultHeroBackground = () => {
  ...
  return (
    <div
      ...
      <div className='absolute md:block md:right-0 top-0 right-1/2 w-[100vw] h-[100vw] sm:w-[50vw] sm:h-[50vw] rounded-full bg-gradient-to-bl from-[#ffea00]/30 to-[#f4a300]/20 transform translate-x-1/2 -translate-y-1/2 blur-xl' />
      <div className='absolute md:block md:right-0 top-0 right-1/2 w-[70vw] h-[70vw] sm:w-[35vw] sm:h-[35vw] rounded-full bg-gradient-to-bl from-[#ffea00]/30 to-[#f4a300]/20 transform translate-x-1/2 -translate-y-1/2 blur-sm' />
    </div>
  );
};
