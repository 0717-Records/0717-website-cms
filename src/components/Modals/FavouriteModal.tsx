...
const FavouriteModal: React.FC<FavouriteModalProps> = ({
  isOpen,
  onClose,
  favourite,
}) => {
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      className="w-[90vw] max-w-[400px] md:max-w-[500px] bg-white rounded-lg overflow-hidden"
      ...
      <div className="p-6 md:p-8 space-y-4">
        ...
        {favourite.genre && (
          <div className="text-center">
            <p className="text-body-base font-medium text-brand-secondary">
              {favourite.genre}
            </p>
          </div>
        )}
        ...
        {favourite.description && (
          <div 
            id="favourite-modal-description"
