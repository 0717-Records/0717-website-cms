    ...
    <Modal
      ...
      <div className='w-full h-full flex flex-col p-4'>
        ...
        <div
          ...
          {/* Current Image */}
          <div className='relative w-full max-w-4xl h-[50vh] sm:h-[60vh] md:h-[70vh] mx-4 sm:mx-8'>
          ...
          {totalImages > 1 && (
            <div className='absolute right-0 top-1/2 -translate-y-1/2 w-16 sm:w-24 md:w-32 h-48 sm:h-64 md:h-80 translate-x-8 sm:translate-x-12 md:translate-x-16 z-10'>
              <button
          ...
          <div className='py-4 mx-auto'>
            <div ref={thumbnailsRef} className='flex gap-2 overflow-x-auto scrollbar-hide px-4'>
              {images.map((image, index) => {
                ...
                const imageAlt = stegaClean(image.image?.alt) || `Gallery thumbnail ${index + 1}`;
